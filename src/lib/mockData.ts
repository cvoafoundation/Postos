...
export const seedData: Record<string, any[]> = {
  ...
  toolkit_categories: [
    { id: 'tc-1', name: "Commander's Toolkit", description: 'Everything a new commander needs to lead a post.', sort_order: 1, created_at: daysAgo(200) },
    { id: 'tc-2', name: 'Meeting Toolkit', description: 'Run meetings that are professional and on-record.', sort_order: 2, created_at: daysAgo(200) },
    { id: 'tc-3', name: 'Recruiting Toolkit', description: 'Grow membership without waiting on National.', sort_order: 3, created_at: daysAgo(200) },
    { id: 'tc-4', name: 'Social Media Toolkit', description: 'Ready-to-post content for every platform and occasion.', sort_order: 4, created_at: daysAgo(200) },
    { id: 'tc-5', name: 'Sponsorship Toolkit', description: 'Everything needed to land and retain local sponsors.', sort_order: 5, created_at: daysAgo(200) },
    { id: 'tc-6', name: 'Fundraising Toolkit', description: 'Run a golf scramble, raffle, or campaign from scratch.', sort_order: 6, created_at: daysAgo(200) },
    { id: 'tc-7', name: 'Veterans Congress Toolkit', description: 'Templates for delegates and legislative work.', sort_order: 7, created_at: daysAgo(200) },
    { id: 'tc-8', name: 'Officer Toolkit', description: 'Role-specific guides for each elected position.', sort_order: 8, created_at: daysAgo(200) },
    { id: 'tc-9', name: 'Compliance Toolkit', description: 'Charter, bylaws, and governance documentation.', sort_order: 9, created_at: daysAgo(200) },
    { id: 'tc-10', name: 'Community Service Toolkit', description: 'Plan outreach and service projects.', sort_order: 10, created_at: daysAgo(200) },
    { id: 'tc-11', name: 'Facility Toolkit', description: 'This is where CVOA becomes different — running a real space.', sort_order: 11, created_at: daysAgo(200) },
    { id: 'tc-12', name: 'Grant Toolkit', description: 'Find and win grant funding.', sort_order: 12, created_at: daysAgo(200) },
    { id: 'tc-13', name: 'Media Toolkit', description: 'Brand assets and approved messaging.', sort_order: 13, created_at: daysAgo(200) },
    { id: 'tc-14', name: 'National Resources', description: 'Who to contact and when.', sort_order: 14, created_at: daysAgo(200) },
  ],

  toolkit_items: [
    { id: 'ti-1', category_id: 'tc-1', title: 'Commander Handbook', sub_items: ['Duties', 'Expectations', 'Reporting requirements', 'Recruiting guide', 'Meeting guide', 'Disciplinary procedures'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-2', category_id: 'tc-1', title: 'First 90 Days Guide', sub_items: ['Week 1', 'Week 2', 'Week 4', 'Month 2', 'Month 3'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-3', category_id: 'tc-2', title: 'Meeting Agenda Templates', sub_items: ['Monthly Meeting', 'Officer Meeting', 'Special Meeting'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a professional meeting agenda for {{post_name}}.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-4', category_id: 'tc-2', title: 'Meeting Minutes Templates', sub_items: ['Standard format', 'Auto-generated PDF'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a meeting minutes template for {{post_name}}.', sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-5', category_id: 'tc-2', title: "Robert's Rules Quick Guide", sub_items: ['Motions', 'Seconds', 'Voting', 'Quorum'], description: null, read_content: "ROBERT'S RULES OF ORDER — QUICK REFERENCE\n\nMOTIONS: A formal proposal — \"I move that...\"\nSECONDS: Another member must second before discussion.\nVOTING: Chair restates the motion and calls the vote.\nQUORUM: Minimum members present to conduct business — check your bylaws.", file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-6', category_id: 'tc-2', title: 'Meeting Scripts', sub_items: ['Opening', 'Pledge', 'Closing'], description: null, read_content: 'OPENING: "This meeting of [Post Name] is called to order..."\nPLEDGE: "Please rise and join me in the Pledge of Allegiance."\nCLOSING: "This meeting stands adjourned. Thank you for your service."', file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-7', category_id: 'tc-3', title: 'Recruiting Flyer Templates', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate recruiting flyer text for {{post_name}} in {{post_city_state}}.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-8', category_id: 'tc-3', title: 'QR Code Generator', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-9', category_id: 'tc-3', title: 'Event Booth Setup Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-10', category_id: 'tc-3', title: 'Recruiting Event Checklist', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a recruiting event checklist for {{post_name}}.', sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-11', category_id: 'tc-3', title: 'New Member Welcome Packet', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a welcome packet for a new member of {{post_name}}.', sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-12', category_id: 'tc-3', title: 'Elevator Pitch', sub_items: null, description: 'When someone asks "What\'s CVOA?" — give commanders approved answers.', read_content: 'SHORT VERSION: "CVOA is a combat veterans organization — we build local posts where veterans get real community, support, and a place that understands what they went through."', file_storage_path: null, generate_prompt_template: null, sort_order: 6, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-13', category_id: 'tc-4', title: 'Facebook Post Library', sub_items: ['Membership drives', 'Veterans Day', 'Memorial Day', 'Independence Day', 'Fundraisers'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate 3 Facebook posts for {{post_name}} for: {{occasion}}.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-14', category_id: 'tc-4', title: 'LinkedIn Templates', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a LinkedIn post for {{post_name}}.', sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-15', category_id: 'tc-4', title: 'Instagram Templates', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate an Instagram caption for {{post_name}}.', sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-16', category_id: 'tc-4', title: 'Political Cartoon Library', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-17', category_id: 'tc-4', title: 'Press Release Templates', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a press release for {{post_name}} announcing: {{announcement}}.', sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-18', category_id: 'tc-5', title: 'Sponsorship Packet', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a sponsorship packet for {{post_name}}.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-19', category_id: 'tc-5', title: 'Sponsor Proposal Template', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a sponsor proposal letter for {{post_name}}.', sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-20', category_id: 'tc-5', title: 'Sponsorship Levels', sub_items: ['Bronze', 'Silver', 'Gold', 'Platinum'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-21', category_id: 'tc-5', title: 'Sponsor Tracking Sheet', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-22', category_id: 'tc-5', title: 'Follow-Up Scripts', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate follow-up scripts for {{post_name}} to use with a quiet sponsor lead.', sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-23', category_id: 'tc-6', title: 'Golf Scramble Kit', sub_items: ['Budget', 'Timeline', 'Sponsor packet', 'Registration form'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a full golf scramble event packet for {{post_name}}.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-24', category_id: 'tc-6', title: 'Raffle Toolkit', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a raffle event plan for {{post_name}}.', sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-25', category_id: 'tc-6', title: 'Silent Auction Toolkit', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a silent auction plan for {{post_name}}.', sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-26', category_id: 'tc-6', title: 'Community Fundraiser Toolkit', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a community fundraiser plan for {{post_name}}.', sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-27', category_id: 'tc-6', title: 'Annual Campaign Toolkit', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate an annual giving campaign plan for {{post_name}}.', sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-28', category_id: 'tc-7', title: 'Resolution Template', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a formal resolution template.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-29', category_id: 'tc-7', title: 'Amendment Template', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate an amendment proposal template.', sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-30', category_id: 'tc-7', title: 'Legislative Position Template', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a legislative position statement template.', sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-31', category_id: 'tc-7', title: 'Delegate Handbook', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-32', category_id: 'tc-7', title: 'Voting Procedures', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-33', category_id: 'tc-8', title: 'Adjutant', sub_items: ['Record keeping', 'Minutes', 'Membership'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-34', category_id: 'tc-8', title: 'Quartermaster', sub_items: ['Budget', 'Accounting', 'Reporting'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-35', category_id: 'tc-8', title: 'Sergeant-at-Arms', sub_items: ['Meeting conduct', 'Ceremonies'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-36', category_id: 'tc-8', title: 'Vice Commander', sub_items: ['Succession planning'], description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-37', category_id: 'tc-9', title: 'Charter Documents', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-38', category_id: 'tc-9', title: 'Bylaws', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-39', category_id: 'tc-9', title: 'Policies', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-40', category_id: 'tc-9', title: 'Conflict of Interest Form', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a standard conflict of interest disclosure form.', sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-41', category_id: 'tc-9', title: 'Officer Acknowledgment Form', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate an officer acknowledgment-of-duties form.', sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-42', category_id: 'tc-9', title: 'Annual Review Checklist', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate an annual compliance review checklist.', sort_order: 6, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-43', category_id: 'tc-10', title: 'Food Drive Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a food drive guide for {{post_name}}.', sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-44', category_id: 'tc-10', title: 'Veteran Outreach Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a veteran outreach plan for {{post_name}}.', sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-45', category_id: 'tc-10', title: 'School Presentation Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a school presentation outline.', sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-46', category_id: 'tc-10', title: 'Community Project Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a community service project framework for {{post_name}}.', sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-47', category_id: 'tc-10', title: 'Event After Action Report', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate an after-action report template for {{post_name}}.', sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-48', category_id: 'tc-11', title: 'How to Find a Building', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-49', category_id: 'tc-11', title: 'Lease Negotiation Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-50', category_id: 'tc-11', title: 'Bar Operations Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-51', category_id: 'tc-11', title: 'Kitchen Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-52', category_id: 'tc-11', title: 'Gym Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-53', category_id: 'tc-11', title: 'Classroom Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 6, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-54', category_id: 'tc-11', title: 'Employment Office Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 7, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-55', category_id: 'tc-11', title: 'VA Partnership Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 8, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-56', category_id: 'tc-11', title: 'Transitional Housing Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 9, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-57', category_id: 'tc-12', title: 'Grant Database', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-58', category_id: 'tc-12', title: 'Grant Calendar', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-59', category_id: 'tc-12', title: 'Grant Writing Templates', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: 'Generate a grant proposal outline for {{post_name}}.', sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-60', category_id: 'tc-12', title: 'Sample Successful Grants', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-61', category_id: 'tc-13', title: 'Logo Files', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-62', category_id: 'tc-13', title: 'Brand Standards', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-63', category_id: 'tc-13', title: 'Approved Language', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-64', category_id: 'tc-13', title: 'Talking Points', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-65', category_id: 'tc-13', title: 'Interview Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-66', category_id: 'tc-13', title: 'Crisis Response Guide', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 6, created_at: daysAgo(200), updated_at: daysAgo(200) },

    { id: 'ti-67', category_id: 'tc-14', title: 'Contact Directory', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 1, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-68', category_id: 'tc-14', title: 'National Leadership', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 2, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-69', category_id: 'tc-14', title: 'State Leadership', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 3, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-70', category_id: 'tc-14', title: 'Subject Matter Experts', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 4, created_at: daysAgo(200), updated_at: daysAgo(200) },
    { id: 'ti-71', category_id: 'tc-14', title: 'Preferred Vendors', sub_items: null, description: null, read_content: null, file_storage_path: null, generate_prompt_template: null, sort_order: 5, created_at: daysAgo(200), updated_at: daysAgo(200) },
  ],
  toolkit_generated_documents: [],
